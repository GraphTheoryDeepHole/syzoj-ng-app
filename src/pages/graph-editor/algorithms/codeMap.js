module.exports = {
  ...
  BFS: {
    pseudo: [
      "起始点Dist(st) = 0，并将其放入队列中，转步骤2；",
      "检查队列是否为空，若不空，转步骤3，否则转步骤5：",
      "取出队首元素v，并执行pop操作使v出队，转步骤4；",
      "对于所有e(v, u)，更新Dist(u) = Dist(v) + 1，并将v放入队列中，转步骤2；",
      "算法结束；"
    ]
  },
  CriticalPath: {
  ...
  HamiltonPath: {
    pseudo: [
      "从0号点开始DFS，转步骤2；",
      "判断当前是否已找到哈密顿回路，若是则转步骤6，否则转步骤3",
      "判断是否可以继续前进，若是转步骤4，否转步骤5，若已回退至起点转步骤6",
      "前进至该节点的后继节点，转步骤2；",
      "无法前进，回退至该节点的前驱，转步骤2；",
      "算法结束；"
    ]
